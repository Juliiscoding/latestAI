            ...
            <Card className="bg-black/50 border border-white/10 hover:border-[#6ACBDF]/50 transition-all duration-300 h-full flex flex-col">
              ...
              <CardFooter>
                <Link href="/signup">
                  ...
                  >
                    Try Pro Plan <ArrowRight className="ml-1 h-4 w-4" />
                  </MovingBorderButton>
                </Link>
              </CardFooter>
            </Card>
              ...
              <CardFooter>
                <Link href="/signup">
                  <MovingBorderButton 
                    borderRadius="0.5rem" 
                    className="bg-[#6ACBDF]/80 text-black font-medium hover:bg-[#6ACBDF]" 
                    containerClassName="h-10 w-52"
                    borderClassName="bg-[radial-gradient(var(--cyan-300)_40%,transparent_60%)]"
                  >
                    Try Enterprise Plan <ArrowRight className="ml-1 h-4 w-4" />
                  </MovingBorderButton>
                </Link>
              </CardFooter>
            </Card>
              ...
              <CardFooter>
                <Link href="/signup">
                  <MovingBorderButton 
                    ...
                    borderClassName="bg-[radial-gradient(var(--cyan-300)_40%,transparent_60%)]"
                  >
                    Try Basic Plan <ArrowRight className="ml-1 h-4 w-4" />
                  </MovingBorderButton>
                </Link>
              </CardFooter>
            </Card>
