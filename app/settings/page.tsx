...
export default function SettingsPage() {
  // Hardcoded user data to avoid any server-side processing
  const userData = {
    name: "Julius",
  ...
  const handleSave = () => {
    // Update the user state with form data (client-side only)
    setUser({
      ...user,
      name: formData.name,
  ...
  return (
    <>
      <div className="flex h-16 shrink-0 items-center justify-between border-b px-4 md:px-6 bg-white text-black">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
