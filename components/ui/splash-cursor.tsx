...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Define pointer prototype class with proper typing
    ...
    // Convert RGB object to array for color handling
    function rgbToArray(color: ColorRGB): [number, number, number] {
